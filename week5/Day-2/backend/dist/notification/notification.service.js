...
let NotificationService = class NotificationService {
    ...
    async createNotification(recipientId, senderId, type, message, relatedCommentId) {
    ...
    async markAsRead(notificationId) {
        ...
        const notification = await this.notificationModel.findByIdAndUpdate(notificationId, { isRead: true }, { new: true });
        if (!notification) {
