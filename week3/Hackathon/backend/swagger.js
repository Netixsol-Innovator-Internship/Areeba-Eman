...
const swaggerDefinition = {
  ...
  info: {
    ...
    description: `
      ...
      ## Features
      - :closed_lock_with_key: JWT-based authentication
      - :memo: Complete task management (CRUD)
      - :mag: Advanced filtering and pagination
      - :bar_chart: Task statistics and analytics
      - :white_check_mark: Input validation on all endpoints
      - :shield: Secure user isolation (users can only access their own tasks)
  ...
  // servers: [
  //   {
  //     url: process.env.NODE_ENV === "production" ? `https://${process.env.VERCEL_URL}` : "https://areeba-week3-day2-backend.vercel.app",
...
const setupSwagger = (app) => {
  ...
  console.log(`:books: Swagger documentation available at: /api-docs`)
  console.log(`:page_facing_up: Swagger JSON available at: /swagger.json`)
}
